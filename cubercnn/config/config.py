...
def get_cfg_defaults(cfg):
    ...
    cfg.MODEL.DETECTOR3D.PETR.FEAT_LEVEL_IDXS = [0, 1, 2, 3]
    cfg.MODEL.DETECTOR3D.PETR.ENC_NUM = 0
    cfg.MODEL.DETECTOR3D.PETR.DEC_NUM = 6
    cfg.MODEL.DETECTOR3D.PETR.CLIP_LINEAR_NORM = False
    cfg.MODEL.DETECTOR3D.PETR.TRANSFORMER_NAME = 'PETR_TRANSFORMR'
    cfg.MODEL.DETECTOR3D.PETR.FLASH_ATTN = False
    ...
    cfg.MODEL.DETECTOR3D.PETR.HEAD.DEPTH_WEIGHT = 0.25
    cfg.MODEL.DETECTOR3D.PETR.HEAD.UV_WEIGHT = 20.0
    cfg.MODEL.DETECTOR3D.PETR.HEAD.DET_2D_L1_WEIGHT = 5.0
    cfg.MODEL.DETECTOR3D.PETR.HEAD.DET_2D_IOU_WEIGHT = 2.0


    cfg.MODEL.DETECTOR3D.PETR.HEAD.PERFORM_2D_DET = True
    cfg.MODEL.DETECTOR3D.PETR.HEAD.VIRTUAL_DEPTH = False
    cfg.MODEL.DETECTOR3D.PETR.HEAD.VIRTUAL_FOCAL_Y = 512.0
    ...
    cfg.MODEL.DETECTOR3D.PETR.BACKBONE_NORM_EVAL = False
